...
| 49 | `dev-docs/**/*.md` spec-doc coverage (`CG-002`) + `query relations` "not found" disambiguation (`L-016`) | CONDITIONAL (GATE DB — funded) | planned | [`phase-49-spec-doc-coverage-and-error-disambiguation.md`](phase-49-spec-doc-coverage-and-error-disambiguation.md) |
| 50–51 | Stage C — shared-agent context/entry points (not funded this gate), re-evaluate against Ledgerkit | CONDITIONAL / EXPERIMENTAL | not started | — |
